...
urlpatterns = [
    ...
    path('table6_data/', views.table6_data, name='table6_data'),
    path('table6_upload/', views.table6_upload, name='table6_upload'),
    path('success_table6/', views.success_table6, name='success_table6'),
