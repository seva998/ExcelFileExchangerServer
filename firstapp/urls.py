...
urlpatterns = [
    ...
    path('table5_data/', views.table5_data, name='table5_data'),
    path('table5_upload/', views.table5_upload, name='table5_upload'),
    path('success_table5/', views.success_table5, name='success_table5'),
